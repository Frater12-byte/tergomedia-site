          ...
          <div className="port-team-grid">
            ...
            <div className="port-team-cards">
              {[
                ...
                <div key={m.name} className="port-team-card">
                  <Image
                    src={m.img}
                    alt={m.name}
                    width={260}
                  ...
                  <div style={{ padding: '18px 20px' }}>
                    ...
                    <a href={m.linkedin} target="_blank" rel="noreferrer" style={{ fontSize: 12, color: 'rgba(255,255,255,.3)', textDecoration: 'none', transition: 'color .15s' }}>LinkedIn →</a>
                  </div>
                </div>
              ))}
            </div>
