...
export const metadata: Metadata = {
  title: 'Professional Services Automation — Client Onboarding & Billing | Tergo Media',
  ...
  keywords: ['professional services automation','client onboarding automation','billing reconciliation','KPI reporting automation','contract renewal tracking','consultancy automation'],
  openGraph: {
    title: 'Professional Services Automation | Tergo Media',
    description: 'Automate client onboarding, billing, reporting, and contract renewals for consultancies and law firms.',
...
export default function ProfessionalServicesPage() {
  return (
    <>
      ...
      <Script id="ps-sector-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
