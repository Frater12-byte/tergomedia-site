...
const PROBLEMS: Problem[] = [
  {
    n: '01', title: 'Slow lead response times', pill: 'From 6h → 90 seconds',
...
const STATS = [
  { val: '90s', label: 'Average lead\nresponse time' },
  { val: '100%', label: 'Follow-up\ncoverage' },
  { val: '8k+', label: 'Tasks automated\nper month' },
  { val: '0', label: 'Leads that\nfall through' },
];
    ...
    <>
      ...
      <section className="page-hero" style={{ background: '#0d0d0d', overflow: 'hidden' }}>
        ...
        <svg className="poly-bg" viewBox="0 0 1440 700" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
          <polygon points="900,0 1440,160 1440,420 1100,520 760,280 820,0" fill="rgba(249,202,0,0.03)" stroke="#f9ca00" strokeWidth="0.6" strokeOpacity="0.12"/>
          <polygon points="1200,0 1440,0 1440,200 1340,160" fill="none" stroke="#f9ca00" strokeWidth="0.5" strokeOpacity="0.1"/>
          <circle cx="900" cy="0" r="2.5" fill="#f9ca00" fillOpacity="0.35"/>
          <circle cx="1100" cy="520" r="2" fill="#f9ca00" fillOpacity="0.2"/>
          <circle cx="760" cy="280" r="1.5" fill="#f9ca00" fillOpacity="0.15"/>
        </svg>

        {/* Photo background — very dark */}
        <div style={{ position: 'absolute', inset: 0, backgroundImage: 'url(https://images.unsplash.com/photo-1613977257363-707ba9348227?w=1600&q=80)', backgroundSize: 'cover', backgroundPosition: 'center', filter: 'brightness(0.12)', zIndex: 0 }} />

        {/* Directional gradient: opaque dark left → semi-transparent right */}
        ...
        {/* Yellow warm glow — emanates from upper-right photo area */}
        ...
        <div className="container">
          ...
          <h1>
            ...
            <em>Qualified in 90 seconds.</em>
          </h1>
          <p>AI lead qualification, CRM sync, viewing coordination, and follow-up sequences — running automatically across all portals while your agents close deals.</p>
          ...
          <div className="met-row">
            <div className="met"><div className="met-b">90<span>s</span></div><div className="met-s">Lead response time</div></div>
            <div className="met"><div className="met-b">100<span>%</span></div><div className="met-s">Follow-up coverage</div></div>
            <div className="met"><div className="met-b">8k<span>+</span></div><div className="met-s">Tasks automated per month</div></div>
            <div className="met"><div className="met-b">0</div><div className="met-s">Leads that fall through</div></div>
          </div>
        </div>
      </section>
