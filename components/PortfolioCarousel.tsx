...
const PROJECTS = [
  ...
  { tc:'p', cat:'n8n · Node.js · PostgreSQL · REST API',         t:'Sidagricrop',           d:'Automated crop reporting, supplier communication, and seasonal inventory management — reducing manual data entry by over 60% across field teams.',                                                                                                                        pbg:'#1a1f1a', ph:'S', href:'/portfolio' },
  { tc:'y', cat:'Python · OpenAI · n8n · Google Sheets API',     t:'Deigma',                d:'AI-driven research workflow automation — data collection, analysis pipelines, and automated client reporting delivered without manual aggregation.',                                                                                                                     pbg:'#1a1a2a', ph:'D', href:'/portfolio' },
  { tc:'c', cat:'WordPress · WooCommerce · HubSpot · Zapier',    t:'Committedag',           d:'End-to-end digital platform for an agricultural commodities business — CRM integration, automated buyer communications, and real-time inventory sync.',                                                                                                                  pbg:'#1a1a1a', ph:'C', href:'https://committedag.com' },
  { tc:'y', cat:'n8n · WhatsApp API · GPT-4o · HubSpot',         t:'Meridian Realty Group', d:'AI-powered lead scoring and WhatsApp follow-up system — every inbound enquiry from Bayut and PropertyFinder qualified, assigned, and followed up in under 90 seconds.',                                                                                                  pbg:'#1f1a1a', ph:'M', href:'/portfolio' },
  { tc:'c', cat:'Make · Airtable · GPT-4o · PDF generation',     t:'Horizons Travel DMC',   d:'Full back-office automation for a destination management company — supplier confirmations, itinerary generation, and margin reporting all running without manual input.',                                                                                                 pbg:'#1a1a1f', ph:'H', href:'/portfolio' },
];
          ...
          {PROJECTS.map(p => (
            <div className={`port-card at-${p.tc}`} key={p.t}>
              {p.img
                ...
                : <div style={{ height:240, background:(p as any).pbg ?? '#1a1a1a', display:'flex', alignItems:'center', justifyContent:'center', fontSize:96, fontWeight:900, color:'rgba(255,255,255,0.06)', fontFamily:"'Exo',sans-serif", userSelect:'none' }}>{(p as any).ph}</div>
              }
