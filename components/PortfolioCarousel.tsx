...
const PROJECTS = [
  { tc:'y', cat:'PHP · HubSpot · RPA',          t:'Cocktail Holidays', d:'PHP/Laravel booking platform integrated with HubSpot CRM and custom RPA workflows. Automated quote generation, supplier confirmations, and payment reconciliation — reducing manual processing by 70% and enabling 3× booking volume without additional headcount.',                      img:'IMG-01', href:'/portfolio' },
  { tc:'c', cat:'Node.js · HubSpot · React',    t:'Agri Novatex',      d:'React distributor portal with a Node.js API layer connecting HubSpot CRM to IoT sensor networks across South Africa and the UK. Automated stock-level alerts, order workflows, and real-time field data dashboards replaced a fully manual distributor communication process.',            img:'IMG-02', href:'/portfolio' },
